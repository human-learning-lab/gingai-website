...
export const BLOCKS: Block[] = [
  ...
  { id: '1500', time: '15:00', name: 'Warm Up',              panel: 'future', tag: '',         tagColor: '',              status: 'future', tZeroOffset: -158 },
  { id: '1550', time: '15:50', name: 'Transfer to Yacht',    panel: 'future', tag: 'Race',     tagColor: 'var(--yellow)', status: 'future', tZeroOffset: -108 },
